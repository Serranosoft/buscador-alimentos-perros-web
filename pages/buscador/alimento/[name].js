...
export default function Ingrediente(props) {
    ...
    return (
        <>
            <Head>
                <title>¿Un perro puede comer {props.result.name}? Respuestas rápidas en BuscaDog</title>
                <meta name="description" content={`¿Un perro puede comer ${props.result.name}? Respuestas rápidas en Buscadog`} />
                <link rel="icon" href="/favicon.ico" />
                <meta property="og:title" content={`¿Un perro puede comer ${props.result.name}? Respuestas rápidas en Buscadog`} />
                ...
                <meta name="twitter:description" content={`¿Un perro puede comer ${props.result.name}? Respuestas rápidas en Buscadog`}></meta>
            ...
            <main className="mainContainer">
                <section className={styles.container}>
                    ...
                    <h1>¿Un perro puede comer <span className={styles.headingVariable}>{props.result.name}</span>?</h1>
                    {props.result.suitable ? <img src="/img/dog-happy.svg" /> : <img src="/img/dog-sad.svg" /> }
                    <div className={styles.descrContainer}>
                        <span>{props.result.descr}</span>
                    </div>
